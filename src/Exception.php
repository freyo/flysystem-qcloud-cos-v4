...
class Exception extends BaseException
{
    protected $errors = [
        ...
        '-46001' => 'COSCOSACCESS_OVERLOAD_ERR COSACCESS请求过载',
        '-46002' => 'COSUSRIDX_OVERLOAD_ERR usridx过载',
        '-46003' => 'COSFILEIDX_OVERLOAD_ERR fileidx过载',
        '-46004' => 'COSCOSFILEMGR_OVERLOAD_ERR cosfilemgr过载',
        '-46005' => 'COSCOSHTTPSVR_OVERLOAD_ERR coshttpsvr过载',
        '-46007' => 'COSBUCKET_OP_OVERLOAD_ERR bucket操作超过过载配置',
        '-46020' => 'COSUSRIDX_TIMEOUT_ERR usridx超时',
        '-46021' => 'COSFILEIDX_TIMEOUT_ERR fileidx超时',
        '-46022' => 'COSCOSFILEMGR_TIMEOUT_ERR cosfilemgr超时',
        '-46023' => 'COSCOSHTTPSVR_TIMEOUT_ERR coshttpsvr超时',
        '-46024' => 'COSCOSDELETE_TIMEOUT_ERR cosdelete超时/COSTEMP_USRIDX_TIMEOUT_ERR 临时索引表超时',
        '-46030' => 'COSENQUEUE_DCC_ERR',
        '-46031' => 'COSENQUEUE_CCD_ERR 写入ccd管道失败',
        '-46101' => 'COSPB_DECODE_ERR pb解码错误',
        '-46102' => 'COSPB_ENCODE_ERR pb解码错误',
        '-46103' => 'COSASN_ENCODE_ERR asn编码失败',
        '-46104' => 'COSASN_DECODE_ERR asn解码失败',
        '-46105' => 'COSINVALID_SUB_TYPE_ERR 协议号错误',
        '-46151' => 'COSINVALID_PATH_ERR path格式不正确',
        '-46152' => 'COSINVALID_BUCKET_NAME_ERR 非法bucketname',
        '-46153' => 'COSBUCKET_NAME_TOO_LONG_ERR bucket名字超过限制',
        '-46154' => 'COSINVALID_APPID_NAME_ERR 非法appid',
        '-46155' => 'COSINVALID_NAME_ERR 非法的名字',
        '-46156' => 'COSILLEGAL_CHAR_IN_PATH_ERR 路径中含有非法字符',
        '-46157' => 'COSNOT_UTF8_ENCODING_ERR 非utf8编码',
        '-46158' => 'COSINVALID_MD5_ERR 非法md5',
        '-46159' => 'COSTOO_MANY_REFER_ERR refer个数超过限制',
        '-46160' => 'COSTOO_MANY_CNAME_ERR cname个数超过限制',
        '-46161' => 'COSREFER_SIZE_ERR 单个refer长度为0或者超过限制',
        '-46162' => 'COSINVALID_REFER_ERR 非法refer',
        '-46163' => 'COSCNAME_SZIE_ERR 单个cname长度为0或者超过限制',
        '-46164' => 'COSINVALID_CNAME_ERR cname错误',
        '-46165' => 'COSREFER_REPEATED_ERR 黑白名单有重复',
        '-46166' => 'COSILLEGAL_CHAR_IN_REFER_ERR refer中含有非法字符',
        '-46167' => 'COSILLEGAL_CHAR_IN_CNAME_ERR cname中含有非法字符',
        '-46168' => 'COSINVALID_RESERVED_ATTR_KEY_ERR 非法reserved',
        '-46169' => 'COSNOT_FILE_RESERVED_ATTR_ERR 不是文件的reservedattr属性',
        '-46170' => 'COSINVALID_HOST_NAME_ERR 非法host',
        '-46171' => 'COSNOT_BUCKET_RESERVED_ATTR_ERR 不是bucket的reserverattr属性',
        '-46172' => 'COSINVALID_PREVIEW_FLAG_ERR 非法预览标志值',
        '-46173' => 'COSINVALID_BROWEREXEC_FLAG_ERR 非法browerexec标志',
        '-46174' => 'COSINVALID_AK_ERR 非法ak',
        '-46175' => 'COSINVALID_SK_ERR 非法sk',
        '-46176' => 'COSINVALID_BIZ_ATTR_ERR 非法bizattr',
        '-46177' => 'COSINVALID_OFFSET_ERR 非法OFFSET',
        '-46178' => 'COSINVALID_DELIMITER_ERR 非法delimiter',
        '-46179' => 'COSINVALID_FORBID_FLAG_ERR 非法forbid标志',
        '-46180' => 'COSSIGN_SIZE_TOO_LONG_ERR sign过长',
        '-46181' => 'COSUSER_REFER_SIZE_TOO_LONG_ERR 下载携带的refer过长',
        '-46182' => 'COSINVALID_AUTH_ERR 非法auth值',
        '-46183' => 'COSFILE_SIZE_ERR 文件长度异常',
        '-46184' => 'COSINVALID_FILE_MD5_ERR 文件md5错误',
        '-46185' => 'COSCUSTOME_HEADER_TOO_LARGE customer总长度超过限制',
        '-46186' => 'COSINVALID_CORS_FLAG_ERR cors标志错误',
        '-46187' => 'COSINVALID_CORS_RULE_ERR cors规则错误',
        '-46188' => 'COSCORSRULE_TOO_LARGE_ERR cors规则总长度超过限制',
        '-46189' => 'COSINVALID_CUSTOM_404_FLAG_ERR 404flag错误',
        '-46190' => 'COSINVALID_CUSTOM_PAGE_NAME_ERR 404、403页面名字非法',
        '-46191' => 'COSINVALIE_CUSTOM_403_FLAG_ERR 403flag错误',
        '-46192' => 'COSINVALIE_IDX_PAGE_FLAG_ERR idxpageflag错误',
        '-46193' => 'COSINVALID_REAL_SHA_ERR realsha不正确',
        '-46194' => 'COSINVALID_TIMESTAMP_ERR ctime、mtime参数错误',
        '-46195' => 'COSINVALID_OUTSOURCE_FLAG_ERR 不正确的outsource',
        '-46196' => 'COSPARSE_PB_ERR 解析PB错误',
        '-46197' => 'COSFILE_APPEND_SIZE_ERR 追加上传的offset和filesize不等',
        '-46198' => 'COSFILE_TYPE_ERR 文件类型错误',
        '-46199' => 'COSFINISH_FILEKEY_NOT_EQUAL_ERR 分块上传fileke不等',
        '-46200' => 'COSBATCH_DEL_NUM_ERR 批量删除数量超过限制',
        '-46301' => 'COSFILEIDX_ERR fileidx异常错误',
        '-46302' => 'COSUSERIDX_ERR usridx异常错误',
        '-46303' => 'COSFILEMGR_ERR cosfilemgr',
        '-46304' => 'COSHTTPSVR_ERR coshttpsvr异常错误',
        '-46305' => 'COSINVAILD_STEP_ERR 状态机异常错误',
        '-46306' => 'COSGET_USRIDX_ADDR_ERR 获取usridx服务器IP错误',
        '-46307' => 'COSGET_FILEMGR_ADDR_ERR 获取filemgr地址错误',
        '-46308' => 'COSGET_HTTPSVR_ADDR_ERR 获取httpsvr地址错误',
        '-46309' => 'COSLAVA_DB_VALUE_SIZE_ERR lavadb返回的value长度有误',
        '-46310' => 'COSGET_COSDELETE_ADDR_ERR 获取cosdelete地址错误',
        '-46311' => 'COSFATHER_NOT_EXIST_ERR 父对象不存在',
        '-46601' => 'COSNORMAL_LOGIC_ERR 其他正常逻辑错误码',
        '-46602' => 'COSDIR_EXIST_ERR 目录冲突，目录已存在,禁止修改',
        '-46603' => 'COSBUCKET_EXIST_ERR bucket已存在',
        '-46604' => 'COSFINISH_FILE_SIZE_ERR 文件长度与finish长度不等',
        '-46605' => 'COSFINISH_SHA_NOT_EQUAL_ERR finish时，传入sha与fileidx中的sha不等',
        '-46607' => 'COSINVALID_MOD_FLAG_ERR mod请求modflag错误',
        '-46608' => 'COSTOO_MANY_BUCKET_ERR bucket数目超过限制',
        '-46609' => 'COSRECORD_EXIST_ERR 记录已存在',
        '-46610' => 'COSINVALID_LIST_NUM_ERR 列表目录时传入的数目错误',
        '-46611' => 'COSINVALID_SHA_ERR 错误的sha',
        '-46613' => 'COSUSRIDX_BLOB_TOO_BIG_ERR usridx',
        '-46614' => 'COSFILE_NOT_UPLOAD_OVER_ERR 文件未上传完成，禁止下载',
        '-46615' => 'COSHIT_WRITE_BLACK_LIST_ERR 命中黑名单',
        '-46616' => 'COSNOT_HIT_WHITE_REFER_ERR 未命中白名单',
        '-46617' => 'COSHIT_BLACK_REFER_ERR 命中黑名单',
        '-46618' => 'COSSIGN_CHECK_FAIL_ERR 签名校验失败',
        '-46619' => 'COSSIGN_EXPIRED_ERR 用户签名过期',
        '-46620' => 'COSBUCKET_FORBID_VISIT_ERR BUCKET禁止访问',
        '-46621' => 'COSFILE_FORBID_VISIT_ERR file禁止访问',
        '-46622' => 'COSINVALID_SLICE_SIZE_ERR 非法分片大小',
        '-46623' => 'COSRECORD_NOT_EXIST_ERR 表示记录不存在',
        '-46624' => 'COSBUCKET_NOT_EMPTY_ERR BUCKET不为空，禁止删除',
        '-46625' => 'COSFILE_ALREADY_FINISH_ERR 文件已完成上传',
        '-46626' => 'COSFILE_CTIME_NOT_EQUAL_ERR 文件ctime不相等',
        '-46627' => 'COSHIT_READ_BLACK_LIST_ERR 命中读黑名单配置',
        '-46628' => 'COSFILE_NOT_EXIST_ERR 文件不存在',
        '-46629' => 'COSBUCKET_NOT_EXIST_ERR BUCKET',
        '-46630' => 'COSFILE_EXISTED_NOT_FINISHED_ERR 文件已存在，但未完成上传',
        '-46631' => 'COSFILE_EXISTED_FINISHED_ERR 文件已存在，并且已完成上传',
        '-50121' => 'COSFILEMGRX_DEL_UNFINISH 删除未完成上传文件',
        '-46632' => 'COSFILE_APPEND_ZERO 追加文件长度为0',
        '-46633' => 'COSFILE_UPLOADIN_NOT_EXIST_ERR uploadid不存在',
        '-46634' => 'COSFILE_IS_FINISHED_ERR 分块文件已经finish',
        '-46635' => 'COSFILE_FINISHED_SHA finish',
        ...
        '-29090' => 'ERR_UPLOADBYKEY_NO_FILEKEY/ERR_NOVALID_TMASTER',
        '-29091' => 'ERR_UPLOADBYKEY_NO_OFFSET/ERR_NOVALID_ACCESS',
        '-29092' => 'ERR_UPLOADBYKEY_NO_DATASIZE/ERR_NOVALID_UPMASTER',
        '-29093' => 'ERR_UPLOADBYKEY_UPLOAD_FLAG/ERR_TMASTER_TIMEOUT',
        '-29094' => 'ERR_UPLOADBYKEY_UKEY_FLAG/ERR_UPMASTER_TIMEOUT',
        '-29095' => 'ERR_UPLOADBYKEY_DATASIZE_CHANGE/ERR_NOVALID_OFFLINESVR',
    ...
    {
        $message = isset($this->errors[$code]) ? $this->errors[$code] : $message;
